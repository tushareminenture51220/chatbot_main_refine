...
const NoUsersFound = ({ title, description }) => {
  return (
    <div className="text-center py-10">
      {/* Heading */}
      <h2 className="mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4x">
        {title}
      </h2>
      ...
      {/* Loading Animation */}
      <div role="status" className="animate-pulse mt-8">
