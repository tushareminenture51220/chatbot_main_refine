...
export const sendOtpMail = async (to, otp) => {
  const msg = {
    ...
    from: {
      ...
      name: "Eminenture Security Team",
    },
    subject: "Your Password Reset Code - Eminenture Account Security",
    text: `
Hello,

You recently requested OTP to reset your password for your Eminenture account. 
    ...
    <tr>
      <td align="center" style="padding: 40px 0;">
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
          ...
          <!-- Header -->
          <tr>
            <td style="padding: 40px 40px 20px 40px; text-align: center; border-bottom: 3px solid #4F46E5;">
              <h1 style="margin: 0; color: #1f2937; font-size: 24px; font-weight: 600;">Eminenture</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px 0; color: #1f2937; font-size: 20px; font-weight: 600;">Password Reset Request</h2>
              ...
              <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 24px;">
                You recently requested OTP to reset your password for your Eminenture account. Use the verification code below to proceed:
              </p>
              
              <!-- OTP Box -->
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 30px 0;">
                <tr>
                  <td align="center" style="padding: 20px; background-color: #f9fafb; border: 2px dashed #d1d5db; border-radius: 8px;">
                    <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 14px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px;">
                      Your Verification Code
                    </p>
                    <p style="margin: 0; color: #4F46E5; font-size: 32px; font-weight: 700; letter-spacing: 4px; font-family: 'Courier New', monospace;">
                      ${otp}
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 16px;">
                    <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 20px;">
                      ⏱️ <strong>Important:</strong> This code will expire in 5 minutes for security purposes.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding: 30px 40px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; border-radius: 0 0 8px 8px;">
              <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 14px; line-height: 20px;">
                Best regards,<br>
                <strong>Eminenture Support Team</strong>
              </p>
              
              <p style="margin: 20px 0 0 0; color: #9ca3af; font-size: 12px; line-height: 18px;">
                This is an automated message, please do not reply to this email. If you need assistance, please visit our support center.
              </p>
              
              <p style="margin: 10px 0 0 0; color: #9ca3af; font-size: 12px; line-height: 18px;">
                © ${new Date().getFullYear()} Eminenture. All rights reserved.
              </p>
            </td>
          </tr>
